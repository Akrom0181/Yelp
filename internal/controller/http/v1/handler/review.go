...
func (h *Handler) CreateReview(ctx *gin.Context) {
	...
	review.Attachment, err = h.UseCase.ReviewAttachmentRepo.MultipleUpsert(ctx, entity.ReviewAttachmentMultipleInsertRequest{
		ReviewId:    review.ID,
...
func (h *Handler) GetReview(ctx *gin.Context) {
	...
	reviewAttachment, err := h.UseCase.ReviewAttachmentRepo.GetList(ctx,
	...
	review.Attachment = reviewAttachment.Items
